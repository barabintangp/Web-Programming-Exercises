<?php
    ...
    if(isset($_POST['submit'])){
        //set cookie username dari namanya, lama cookie 3 bulan
        setcookie("username",$_POST['username'],time()+3*30*24*3600,"/");
        //set cookie jumlah kunjungan->0 (mula-mula)
        setcookie("visits",0,time()+3*30*24*3600,"/");
        //set cookie kunjungan terakhir
    ...
    if(isset($_COOKIE['username'])){
        ...
        echo "<p>Halo, selamat datang ".$_COOKIE['username']."</p>";
